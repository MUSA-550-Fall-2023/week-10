...
1. [Visualizing recent shootings in Philadelphia using Altair, Folium, and Holoviews](https://github.com/MUSA-550-Fall-2022/philadelphia-shootings-app)
1. [Visualizing NYC taxi trips with Datashader and Altair](https://github.com/MUSA-550-Fall-2022/datashader-nyc-taxi-app)
...
- Heroku
  ...
  - See the example [instructions](https://github.com/MUSA-550-Fall-2022/philadelphia-shootings-app#deploying-this-app-on-heroku) for deploying the Philadelphia Shootings App on Heroku
